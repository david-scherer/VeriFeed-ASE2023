"""
copied from Github for customization
"""
...
class SentimentIntensityAnalyzer(object):
    ...
    def polarity_scores(self, text):
        ...
        sentiments = self._check_contrastive_terms(words_and_emoticons, sentiments)
    ...
    @staticmethod
    def _check_contrastive_terms(words_and_emoticons, sentiments):
        # check for modification in sentiment due to contrastive conjunction 'but'
        words_and_emoticons_lower = [str(w).lower() for w in words_and_emoticons]
        contrastive_terms = ["but", "however", "nevertheless", "though", "although", "despite"]
        for term in contrastive_terms:
            if term in words_and_emoticons_lower:
                bi = words_and_emoticons_lower.index(term)
